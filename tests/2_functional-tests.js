...
=======
>>>>>>> 5294694d33fa564f3ebba3759e61b962b259e10c
...
>>>>>>> 5294694d33fa564f3ebba3759e61b962b259e10c
            test('Test GET /hello with your name', function(done) { // Don't forget the callback...
                chai.request(server) // 'server' is the Express App
                    .get('/hello?name=Christian') /** <=== Put your name in the query **/
                    .end(function(err, res) { // res is the response object
                        ...
                        assert.equal(res.status, 200);
                        assert.equal(res.text, 'hello Christian' /** <==  Put your name here **/ );
                        done(); // Always call the 'done()' callback when finished.
                    });
            });
<<<<<<< HEAD
            ...
            test('send {surname: "Colombo"}', function(done) {
                ...
                chai.request(server)
                    ...
                    .end(function(err, res) {
                        ...
                        /** your tests here **/
                        assert.equal(res.status, 200, 'res. status = 200');
                        assert.equal(res.type, 'application/json', 'res. = JSON');
                        assert.equal(res.body.name, 'Cristoforo', 'name = Cristoforo');
                        assert.equal(res.body.surname, 'Colombo', 'surname = Colombo');
            ...
            test('send {surname: "da Verrazzano"}', function(done) {
                ...
                chai.request(server)
                    ...
                    .end(function(err, res) {
                        ...
                        assert.equal(res.type, 'application/json', 'res. = JSON');
                        // assert.equal(res.body.name, 'Cristoforo', 'name = Cristoforo');
                        assert.equal(res.body.surname, 'da Verrazzano', 'surname = da Verrazzano');
                        done();
                    });
            });
        });
